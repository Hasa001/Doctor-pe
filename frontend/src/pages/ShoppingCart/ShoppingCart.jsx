...
export const ShoppingCart = () => {
    ...
    const handleClick = async () => {
        ...
        const response = await axios.post("https://doctor-pe-backend.vercel.app/api/v1/product/purchaseProduct/createCheckoutSession", {
        ...
        <div className="bg-gradient-to-br from-slate-100 to-cyan-100 min-h-screen pt-12 mx-auto px-6">
            <div>
                ...
                <div className="flex justify-between p-10 mb-8 ">
                    ...
                    <div className="yourItems bg-white w-1/4 mt-20 rounded-3xl shadow-xl">
